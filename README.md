...
面板稳定选择具有有效刘海区域的显示屏。静止时，黑色外壳从屏幕顶边延伸到刘海两侧，分别显示应用和任务指示器；悬停后横向展开额度和重置时间，点击后向下展开详情，可切换“额度 / 活动 / 用量”。“刘海常驻形态”默认为“静止态 Compact”；选择“额度预览态 Peek”后，静止时保留额度预览。详情中的长内容可滚动，底部提供刷新、设置、隐藏和收起。任务变化不会自动展开面板。
