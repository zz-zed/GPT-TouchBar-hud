> 历史记录：Build 30 已由 [Build 31 发布准备](RELEASE-PREPARATION-0.1.29.md) 取代。文中的旧 worktree 路径是当时的构建位置；清理后的产物位置见新记录的归档映射。
...
- 可提交清单：[release-0.1.29-artifact-manifest.json](validation/release-0.1.29-build30-artifact-manifest.json)。
